...
fun Aplicacion(modifier: Modifier){
    fun al_pulsar_el_carrito(){
        Log.v("Aplicacion", "Se ha pulsado el boton y utilizando la funcion al pulsar el carrito")
    }
    ...
    { padding_interior ->
        Column(modifier = Modifier.fillMaxSize().padding(padding_interior).background(Color.Cyan)){
